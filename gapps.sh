...
package="open_gapps-arm-6.0-tvstock-20160816-UNOFFICIAL.zip"
...
if [ ! -d org ]; then
  ...
  wget https://dl.dropboxusercontent.com/content_link/v2Bb1YajUewDSeks8bsmYLd52uvq3SKAzn298i4XDJ29yHj7Ehnw5mtlD53WpWvj/file?dl=1
  unzip $package -d org
fi
